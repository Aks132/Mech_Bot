...
void ibus_loop() {
  ...
  if (channel_data[9] < 1500) {
    if (channel_data[2] <= 2000 && channel_data[2] >= 1000) {
      throttle = map(channel_data[2], 1000, 2000 , 40 , 104);
    }
  }
  else {
    if (channel_data[2] <= 2000 && channel_data[2] >= 1000) {
      throttle = map(channel_data[2], 1000, 2000 , 40 , 174);
    }
  }
...
//    left_side_light = 'N';
//  }
//  else if(channel_data[9] == 1000){
//    left_side_light = 'F';
//  }

  if (1000 <= channel_data[8] && channel_data[8]<= 1400) {
    right_side_light = 'N';
    left_side_light = 'F';
    
  }
  else if(1600 <= channel_data[8] && channel_data[8] <= 2000){
    right_side_light = 'F';
    left_side_light = 'N';
